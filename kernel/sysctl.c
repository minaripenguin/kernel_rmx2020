...
/*tianwen@PSW.BSP.Kernel.Storage, 2020-01-08, add async discard switch*/
{
...
#ifdef CONFIG_SCHED_DEBUG
	{
		.procname	= "noinit_sched_min_granularity_ns",
	...
	{
		.procname	= "noinit_sched_latency_ns",
	...
	{
		.procname	= "noinit_sched_wakeup_granularity_ns",
...
#ifdef CONFIG_SMP
	{
		.procname	= "noinit_sched_tunable_scaling",
	...
	{
		.procname	= "noinit_sched_migration_cost_ns",
...
static struct ctl_table vm_table[] = {
	...
	{
		.procname	= "noinit_dirty_background_ratio",
	...
	{
		.procname	= "noinit_dirty_writeback_centisecs",
	...
	{
		.procname	= "noinit_dirty_expire_centisecs",
